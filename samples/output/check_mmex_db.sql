...
SELECT 
  ...
  , 'UPDATE CHECKINGACCOUNT_V1 SET DELETEDTIME = "" WHERE CHECKINGACCOUNT_V1.TRANSID = ' || __LEFT_TABLE.TRANSID || '
' AS FIX  , 'CHECKINGACCOUNT_V1.DELETEDTIME is null' AS MESSAGE
...
SELECT 
  ...
  , 'DELETE FROM BILLSDEPOSITS_V1 WHERE BILLSDEPOSITS_V1.BDID = ' || __LEFT_TABLE.BDID || '
' AS FIX  , 'PAYEEID of BILLSDEPOSITS_V1 is not in table PAYEE_V1 by PAYEEID' AS MESSAGE
FROM BILLSDEPOSITS_V1 AS __LEFT_TABLE
...
SELECT 
  ...
  , null AS FIX
  , 'NOT ( BILLSDEPOSITS_V1.COLOR in (-1, 0, 1, 2, 3, 4, 5, 6, 7) )' AS MESSAGE
FROM BILLSDEPOSITS_V1 AS __LEFT_TABLE
WHERE NOT ( ( __LEFT_TABLE.COLOR in (-1, 0, 1, 2, 3, 4, 5, 6, 7) ) )
union
SELECT 
    'CURRENCYHISTORY_V1.CURRENCYID in CURRENCYFORMATS_V1' AS ID
  , 'E' AS SEVERITY
  , 'CURRENCYHISTORY_V1' AS TABLE_NAME_VALUE
  , 'CURRHISTID' AS TABLE_PK_NAME
  , __LEFT_TABLE.CURRHISTID AS TABLE_PK_VALUE
  , 'CURRENCYID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.CURRENCYID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'CURRENCYID of CURRENCYHISTORY_V1 is not in table CURRENCYFORMATS_V1 by CURRENCYID' AS MESSAGE
FROM CURRENCYHISTORY_V1 AS __LEFT_TABLE
LEFT JOIN CURRENCYFORMATS_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.CURRENCYID = __LEFT_TABLE.CURRENCYID
WHERE ( __RIGHT_TABLE.CURRENCYID is null ) 
union
SELECT 
...
union
SELECT 
    'SPLITTRANSACTIONS_V1.CATEGID in CATEGORY_V1' AS ID
  , 'E' AS SEVERITY
  , 'SPLITTRANSACTIONS_V1' AS TABLE_NAME_VALUE
  , 'SPLITTRANSID' AS TABLE_PK_NAME
  , __LEFT_TABLE.SPLITTRANSID AS TABLE_PK_VALUE
  ...
  , __LEFT_TABLE.CATEGID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'CATEGID of SPLITTRANSACTIONS_V1 is not in table CATEGORY_V1 by CATEGID' AS MESSAGE
FROM SPLITTRANSACTIONS_V1 AS __LEFT_TABLE
LEFT JOIN CATEGORY_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.CATEGID = __LEFT_TABLE.CATEGID
WHERE ( __RIGHT_TABLE.CATEGID is null ) 
union
SELECT 
    'BUDGETSPLITTRANSACTIONS_V1.TRANSID in CHECKINGACCOUNT_V1' AS ID
  , 'E' AS SEVERITY
  , 'BUDGETSPLITTRANSACTIONS_V1' AS TABLE_NAME_VALUE
  , 'SPLITTRANSID' AS TABLE_PK_NAME
  , __LEFT_TABLE.SPLITTRANSID AS TABLE_PK_VALUE
  , 'TRANSID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.TRANSID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'TRANSID of BUDGETSPLITTRANSACTIONS_V1 is not in table CHECKINGACCOUNT_V1 by TRANSID' AS MESSAGE
FROM BUDGETSPLITTRANSACTIONS_V1 AS __LEFT_TABLE
LEFT JOIN CHECKINGACCOUNT_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.TRANSID = __LEFT_TABLE.TRANSID
WHERE ( __RIGHT_TABLE.TRANSID is null ) 
union
SELECT 
    'BUDGETSPLITTRANSACTIONS_V1.CATEGID in CATEGORY_V1' AS ID
  , 'E' AS SEVERITY
  , 'BUDGETSPLITTRANSACTIONS_V1' AS TABLE_NAME_VALUE
  , 'SPLITTRANSID' AS TABLE_PK_NAME
  , __LEFT_TABLE.SPLITTRANSID AS TABLE_PK_VALUE
  ...
  , __LEFT_TABLE.CATEGID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'CATEGID of BUDGETSPLITTRANSACTIONS_V1 is not in table CATEGORY_V1 by CATEGID' AS MESSAGE
FROM BUDGETSPLITTRANSACTIONS_V1 AS __LEFT_TABLE
LEFT JOIN CATEGORY_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.CATEGID = __LEFT_TABLE.CATEGID
WHERE ( __RIGHT_TABLE.CATEGID is null ) 
union
SELECT 
    'BUDGETTABLE_V1.BUDGETYEARID in BUDGETYEAR_V1' AS ID
  , 'E' AS SEVERITY
  , 'BUDGETTABLE_V1' AS TABLE_NAME_VALUE
  , 'BUDGETENTRYID' AS TABLE_PK_NAME
  , __LEFT_TABLE.BUDGETENTRYID AS TABLE_PK_VALUE
  , 'BUDGETYEARID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.BUDGETYEARID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'BUDGETYEARID of BUDGETTABLE_V1 is not in table BUDGETYEAR_V1 by BUDGETYEARID' AS MESSAGE
FROM BUDGETTABLE_V1 AS __LEFT_TABLE
LEFT JOIN BUDGETYEAR_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.BUDGETYEARID = __LEFT_TABLE.BUDGETYEARID
WHERE ( __RIGHT_TABLE.BUDGETYEARID is null ) 
union
SELECT 
    'BUDGETTABLE_V1.CATEGID in CATEGORY_V1' AS ID
  , 'E' AS SEVERITY
  , 'BUDGETTABLE_V1' AS TABLE_NAME_VALUE
  , 'BUDGETENTRYID' AS TABLE_PK_NAME
  , __LEFT_TABLE.BUDGETENTRYID AS TABLE_PK_VALUE
  ...
  , __LEFT_TABLE.CATEGID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'CATEGID of BUDGETTABLE_V1 is not in table CATEGORY_V1 by CATEGID' AS MESSAGE
FROM BUDGETTABLE_V1 AS __LEFT_TABLE
LEFT JOIN CATEGORY_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.CATEGID = __LEFT_TABLE.CATEGID
WHERE ( __RIGHT_TABLE.CATEGID is null ) 
union
SELECT 
    'ATTACHMENT_V1.REFID in CHECKINGACCOUNT_V1' AS ID
  , 'E' AS SEVERITY
  , 'ATTACHMENT_V1' AS TABLE_NAME_VALUE
  , 'ATTACHMENTID' AS TABLE_PK_NAME
  , __LEFT_TABLE.ATTACHMENTID AS TABLE_PK_VALUE
  , 'REFID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.REFID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'REFID of ATTACHMENT_V1 is not in table CHECKINGACCOUNT_V1 by TRANSID' AS MESSAGE
FROM ATTACHMENT_V1 AS __LEFT_TABLE
LEFT JOIN CHECKINGACCOUNT_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.TRANSID = __LEFT_TABLE.REFID
WHERE ( __LEFT_TABLE.REFTYPE = "Transaction" )
AND ( __RIGHT_TABLE.TRANSID is null ) 
union
SELECT 
    'ATTACHMENT_V1.REFID in BILLSDEPOSITS_V1' AS ID
  , 'E' AS SEVERITY
  , 'ATTACHMENT_V1' AS TABLE_NAME_VALUE
  , 'ATTACHMENTID' AS TABLE_PK_NAME
  , __LEFT_TABLE.ATTACHMENTID AS TABLE_PK_VALUE
  ...
  , __LEFT_TABLE.REFID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'REFID of ATTACHMENT_V1 is not in table BILLSDEPOSITS_V1 by BDID' AS MESSAGE
FROM ATTACHMENT_V1 AS __LEFT_TABLE
LEFT JOIN BILLSDEPOSITS_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.BDID = __LEFT_TABLE.REFID
WHERE ( __LEFT_TABLE.REFTYPE = "RecurringTransaction" )
AND ( __RIGHT_TABLE.BDID is null ) 
union
SELECT 
    'TAGLINK_V1.REFID in CHECKINGACCOUNT_V1' AS ID
  , 'E' AS SEVERITY
  , 'TAGLINK_V1' AS TABLE_NAME_VALUE
  , 'TAGLINKID' AS TABLE_PK_NAME
  , __LEFT_TABLE.TAGLINKID AS TABLE_PK_VALUE
  , 'REFID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.REFID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'REFID of TAGLINK_V1 is not in table CHECKINGACCOUNT_V1 by TRANSID' AS MESSAGE
FROM TAGLINK_V1 AS __LEFT_TABLE
LEFT JOIN CHECKINGACCOUNT_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.TRANSID = __LEFT_TABLE.REFID
WHERE ( __LEFT_TABLE.REFTYPE = 'Transaction' )
AND ( __RIGHT_TABLE.TRANSID is null ) 
union
SELECT 
    'TAGLINK_V1.REFID in BILLSDEPOSITS_V1' AS ID
  , 'E' AS SEVERITY
  , 'TAGLINK_V1' AS TABLE_NAME_VALUE
  , 'TAGLINKID' AS TABLE_PK_NAME
  , __LEFT_TABLE.TAGLINKID AS TABLE_PK_VALUE
  ...
  , __LEFT_TABLE.REFID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'REFID of TAGLINK_V1 is not in table BILLSDEPOSITS_V1 by BDID' AS MESSAGE
FROM TAGLINK_V1 AS __LEFT_TABLE
LEFT JOIN BILLSDEPOSITS_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.BDID = __LEFT_TABLE.REFID
WHERE ( __LEFT_TABLE.REFTYPE = 'RecurringTransaction' )
AND ( __RIGHT_TABLE.BDID is null ) 
union
SELECT 
    'TAGLINK_V1.TAGID in TAG_V1' AS ID
  , 'E' AS SEVERITY
  , 'TAGLINK_V1' AS TABLE_NAME_VALUE
  , 'TAGLINKID' AS TABLE_PK_NAME
  , __LEFT_TABLE.TAGLINKID AS TABLE_PK_VALUE
  , 'TAGID' AS TABLE_FIELD_NAME
  , __LEFT_TABLE.TAGID AS TABLE_FIELD_VALUE
  , null AS FIX
  , 'TAGID of TAGLINK_V1 is not in table TAG_V1 by TAGID' AS MESSAGE
FROM TAGLINK_V1 AS __LEFT_TABLE
LEFT JOIN TAG_V1 AS __RIGHT_TABLE ON __RIGHT_TABLE.TAGID = __LEFT_TABLE.TAGID
WHERE ( __RIGHT_TABLE.TAGID is null ) 
;
